...
namespace BattleShip {
    internal class MapVM : ViewModelBase {                
        ...
        public ObservableCollection<ShipVM> ShipsView { get; } = new();
        public ObservableCollection<ShipVM> Ships { get; } = new();
        ...
        internal void SetShips(List<ShipVM> ships) {            
        ...
        internal void DeleteShip(ShipVM ship) {
